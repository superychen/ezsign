...
public class CreateCert {
    ...
    public Certinfo createCert(String certMsg) {
        String  host  =  certProperties.getHost(); //测试环境
...
//            System.out.println("证书密码 = " + pwfpwd);
            ...
            certinfo.setCertinfoPfx(certinfoPfx.getBytes());//证书PFX,二进制文件
            certinfo.setCertinfoPwd(pwfpwd);//证书密码
            certinfo.setCertinfoCer(signCert.getBytes());//证书CER文件,二进制文件
