...
public class CompanyAgentServiceImpl implements CompanyAgentService {
    ...
    public Boolean agentAuth(byte[] bytes, String originalFilename, String companyinfoAgent,
        ...
        //TODO 管理端那边通过后，需要进行认证之后的操作，我在写一个接口让他们进行下一步操作
    ...
    protected Companyinfo queryCompany(String companyinfoName){
        ...
        //将查询到的结果转换为json字符串
        String jsonCompany = ToJson.stringToJson(String.valueOf(getResult.get("data")));

        Companyinfo companyinfo = JSONObject.parseObject(jsonCompany, Companyinfo.class);
