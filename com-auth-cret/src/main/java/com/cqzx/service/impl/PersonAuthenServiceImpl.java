...
public class PersonAuthenServiceImpl implements PersonAuthenService {
     ...
     * @param perosoninfo idCardname 身份证姓名，idCardnumber 身份证号码，telephone 手机号码
     * @return true/false
     */
    @Override
    public Boolean updateAfterFace(Perosoninfo perosoninfo) {
        //先判断当前的personinfo是否已经认证过了的,就不能在认证
        Map<String, Object> personMap = dbService.get("personinfo", "personinfo_idcard", perosoninfo.getPersoninfoIdcard());
