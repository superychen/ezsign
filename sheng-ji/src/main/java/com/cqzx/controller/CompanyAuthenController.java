...
public class CompanyAuthenController {
    ...
    /**
     * 查询单个企业信息
     * @param companyInfoId 企业对应的当前的Id
     */
    @GetMapping("/oneCompany")
    public Companyinfo getOneCompany(@RequestParam("companyInfoId") String companyInfoId){
        return companyAuthenService.getOneCompany(companyInfoId);
    }
}
