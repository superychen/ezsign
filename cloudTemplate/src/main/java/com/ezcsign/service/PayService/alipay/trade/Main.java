...
import com.ezcsign.service.PayService.alipay.trade.model.builder.*;
...
import com.ezcsign.service.PayService.alipay.trade.service.impl.AlipayTradeWithHBServiceImpl;
...
public class Main {
 ...
 //       main.test_trade_precreate();
    ...
    public void test_trade_query() {
        ...
        String outTradeNo ="tradeprecreate15687034652214697871";
...
//                    response.getOutTradeNo());
                String filePath = String.format("D:/%s.png",
                        response.getOutTradeNo());
