...
import com.ezcsign.service.PayService.tenpay.util.JsonUtil;
...
public class AccessTokenRequestHandler extends RequestHandler {
	...
	protected static String getTokenReal() {
		String requestUrl = ConstantUtil.TOKENURL + "?grant_type=" + ConstantUtil.GRANT_TYPE + "&appid=" + ConstantUtil.APP_ID + "&secret=" + ConstantUtil.APP_SECRET;
		String resContent;
	...
	private static boolean tokenIsExpire(String access_token) {
		...
		// 生成支付签名
		String sign = wxReqHandler.createSign();
