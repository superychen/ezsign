...
public enum ExceptionEnums {
    ...
    MEMBER_SHOULD_AUTH(500,"进入企业签必须先通过认证"),
    COMPANY_SHOULD_AUTH(500,"进入企业签必须通过认证"),
    TYPE_CONVERT_ERROR(500,"类型转换异常"),
    ADMIN_MEMBER_INFO_NOE_FOUND(500,"当前的超级管理员未查到"),
    NOT_FOUND_PERSON_INFO(401,"未查找到个人相关的信息")
    ;
    private int code;
    private String msg;
}
